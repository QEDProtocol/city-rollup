...
use plonky2::plonk::{
    circuit_builder::CircuitBuilder, config::GenericConfig, proof::ProofWithPublicInputs,
};
use serde::{de::DeserializeOwned, Serialize};
use std::{marker::PhantomData, sync::Mutex};

use crate::common::tree_planner::{BinaryTreeJob, BinaryTreePlanner, TreePosition};

use super::traits::{TPLeafAggregator, TreeProverAggCircuit, TreeProverLeafCircuit};

use rayon::prelude::*;
pub struct LeafInput<IL, LC> {
    pub input: Mutex<IL>,
    pub leaf_circuit: Mutex<LC>,
}
pub struct AggInput<IO, LC> {
    pub input: Mutex<IO>,
    pub leaf_circuit: Mutex<LC>,
}
