...
impl<F: RichField> QRPCProcessor<F> {
    ...
    pub fn injest_rpc_claim_deposit<PS: QProofStore>(
        ...
        println!(
            "[injest_rpc_claim_deposit] setting_signature_proof_id: {} ({:?})",
            signature_proof_id.to_hex_string(),
            signature_proof_id
        );
    ...
    pub fn injest_rpc_token_transfer<PS: QProofStore>(
        ...
        println!(
            "[injest_rpc_token_transfer] setting_signature_proof_id: {} ({:?})",
            signature_proof_id.to_hex_string(),
            signature_proof_id
        );
        ps.set_bytes_by_id(signature_proof_id, &req.signature_proof)?;
    ...
    pub fn injest_rpc_add_withdrawal<PS: QProofStore>(
        ...
        println!(
            "[injest_rpc_add_withdrawal] setting_signature_proof_id: {} ({:?})",
            signature_proof_id.to_hex_string(),
            signature_proof_id
        );
        ps.set_bytes_by_id(signature_proof_id, &req.signature_proof)?;
