...
use crate::{
    btc::{
        data::rollup::introspection::{
            BlockSpendIntrospectionGadgetConfig, BlockSpendIntrospectionHint,
        },
        gadgets::{sighash::SigHashPreimageBytesGadget, transaction::BTCTransactionBytesGadget},
    },
    common::{
        builder::{
