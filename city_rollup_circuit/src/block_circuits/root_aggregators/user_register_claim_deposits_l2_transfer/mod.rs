...
#[derive(Debug)]
pub struct CRAggUserRegisterClaimDepositL2TransferCircuit<C: GenericConfig<D>, const D: usize>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
    ...
    pub child_common_data: CommonCircuitData<C::F, D>,
    pub child_verifier_cap_height: usize,
    pub circuit_data: CircuitData<C::F, C, D>,
    pub fingerprint: QHashOut<C::F>,
}
impl<C: GenericConfig<D>, const D: usize> Clone
    ...
    C::Hasher: AlgebraicHasher<C::F>,
{
    fn clone(&self) -> Self {
        Self::new(
            self.op_register_user_fingerprint,
            self.op_claim_l1_deposit_fingerprint,
            self.op_l2_transfer_fingerprint,
            &self.child_common_data,
            self.child_verifier_cap_height,
        )
    }
}
impl<C: GenericConfig<D>, const D: usize> CRAggUserRegisterClaimDepositL2TransferCircuit<C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
    pub fn new(
        ...
        Self {
            ...
            op_claim_l1_deposit_fingerprint,
            op_l2_transfer_fingerprint,
            child_common_data: child_common_data.clone(),
            child_verifier_cap_height,
            circuit_data,
            fingerprint,
        }
    }
