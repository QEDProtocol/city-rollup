...
use crate::common::{
    builder::{optional_inputs::CircuitBuilderOptionalInputs, select::CircuitBuilderSelectHelpers},
    hash::merkle::helpers::merkle_proof::{MerkleProof, MerkleProofBase},
    QHashOut,
};
...
mod tests {
    ...
    use crate::common::hash::merkle::gadgets::merkle_proof::{
        MerkleProofGadget, OptionalMerkleProofGadget,
    };
    use crate::common::hash::merkle::helpers::merkle_proof::MerkleProof;
