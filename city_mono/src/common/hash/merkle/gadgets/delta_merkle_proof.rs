...
use crate::common::{
    ...
    hash::{
        merkle::helpers::merkle_proof::{
            DeltaMerkleProof, DeltaMerkleProofBase, DeltaMerkleProofCore,
        },
...
mod tests {
    ...
    use crate::common::hash::merkle::gadgets::delta_merkle_proof::{
        DeltaMerkleProofGadget, OptionalDeltaMerkleProofGadget,
    };
    use crate::common::hash::merkle::helpers::merkle_proof::DeltaMerkleProof;
