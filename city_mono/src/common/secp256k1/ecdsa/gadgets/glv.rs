...
use super::super::curve::glv::{decompose_secp256k1_scalar, GLV_BETA, GLV_S};
use super::super::curve::secp256k1::Secp256K1;
...
mod tests {
    ...
    use super::super::super::curve::curve_types::{Curve, CurveScalar};
    use super::super::super::curve::glv::glv_mul;
    use super::super::super::curve::secp256k1::Secp256K1;
